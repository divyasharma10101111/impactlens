...
# --- Fix Option 2: ensure project root is on PYTHONPATH for Streamlit ---
...
# --- Logo (put file at: <project_root>/assets/impactlens_logo.png) ---
LOGO_PATH = ROOT / "assets" / "impactlens_logo.png"
if LOGO_PATH.exists():
